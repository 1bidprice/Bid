...
function MainApp() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}><StatusBar barStyle="dark-content" backgroundColor="#eef5ff" /><View style={styles.app}>
...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: '#eef5ff' }, app: { flex: 1 }, scroll: { flex: 1 }, content: { paddingHorizontal: 20, paddingTop: 20, paddingBottom: 125 },
  ...
  title: { color: '#16345f', fontSize: 40, lineHeight: 45, fontWeight: '900' }, titleCompact: { fontSize: 34 }, versionLine: { color: '#718096', marginTop: 4, fontWeight: '700' }, rowTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }, grow: { flex: 1 },
  ...
  grid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', rowGap: 12, marginTop: 14 }, metric: { width: '48%', minHeight: 118, borderRadius: 24, borderWidth: 1, borderColor: '#d5dfec', backgroundColor: '#fff', padding: 17, justifyContent: 'space-between' }, metricCompact: { paddingHorizontal: 13 }, metricValue: { color: '#16345f', fontSize: 23, lineHeight: 29, fontWeight: '900', marginTop: 12 }, red: { color: '#d83b4d' }, green: { color: '#078548' },
  ...
  sectionRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginTop: 28, marginBottom: 12 }, section: { color: '#16345f', fontSize: 31, lineHeight: 38, fontWeight: '900', marginTop: 28, marginBottom: 14 }, subsection: { color: '#16345f', fontSize: 24, fontWeight: '900', marginTop: 22, marginBottom: 10 },
  card: { backgroundColor: '#fff', borderRadius: 26, borderWidth: 1, borderColor: '#d4deeb', padding: 20, marginBottom: 14 }, cardTitle: { color: '#16345f', fontSize: 24, lineHeight: 29, fontWeight: '900' }, badge: { backgroundColor: '#edf4ff', paddingHorizontal: 13, paddingVertical: 9, borderRadius: 18 }, badgeText: { color: '#0B66FF', fontWeight: '900', fontSize: 13 }, badgeBad: { backgroundColor: '#fff0f2' }, badgeBadText: { color: '#d83b4d' },
  priceRow: { flexDirection: 'row', alignItems: 'flex-end', marginTop: 22, gap: 12 }, big: { color: '#16345f', fontSize: 43, lineHeight: 49, fontWeight: '900', marginTop: 2 }, change: { fontSize: 22, fontWeight: '900', paddingBottom: 8 }, note: { color: '#67768c', fontSize: 15, lineHeight: 23, marginTop: 10 }, source: { color: '#8591a3', fontSize: 13, lineHeight: 20, marginTop: 10 }, tapHint: { color: '#0B66FF', fontWeight: '800', marginTop: 15, fontSize: 13 }, detailPanel: { borderTopWidth: 1, borderTopColor: '#e5ebf3', marginTop: 16, paddingTop: 14 },
  ...
  historyItem: { backgroundColor: '#fff', borderRadius: 20, borderWidth: 1, borderColor: '#d4deeb', padding: 16, marginBottom: 10 }, switchLine: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 14 }, nav: { position: 'absolute', left: 0, right: 0, bottom: 0, minHeight: 86, backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#dbe3ee', flexDirection: 'row', paddingHorizontal: 8, paddingTop: 7, paddingBottom: Platform.OS === 'android' ? 10 : 16 }, navItem: { flex: 1, borderRadius: 20, alignItems: 'center', justifyContent: 'center', paddingVertical: 7 }, navItemOn: { backgroundColor: '#edf4ff' }, navIcon: { color: '#7c899d', fontSize: 22, fontWeight: '900' }, navText: { color: '#7c899d', fontSize: 11, marginTop: 2, fontWeight: '800' }, navTextOn: { color: '#0B66FF' },
  overlay: { flex: 1, backgroundColor: 'rgba(10, 25, 50, 0.45)', justifyContent: 'flex-end' }, keyboardLayer: { maxHeight: '94%', width: '100%' }, sheet: { backgroundColor: '#f8fbff', borderTopLeftRadius: 30, borderTopRightRadius: 30, overflow: 'hidden' }, form: { padding: 22, paddingBottom: 34 }, sheetTitle: { color: '#16345f', fontSize: 29, fontWeight: '900' }, link: { color: '#0B66FF', fontWeight: '900', fontSize: 16 }, progressRow: { flexDirection: 'row', gap: 7, marginVertical: 18 }, progressBar: { flex: 1, height: 5, borderRadius: 4, backgroundColor: '#dce5f0' }, progressBarOn: { backgroundColor: '#0B66FF' }, formSection: { color: '#16345f', fontWeight: '900', fontSize: 21, marginBottom: 12 },
  field: { marginBottom: 15 }, fieldLabel: { color: '#233d63', fontSize: 15, fontWeight: '900', marginBottom: 7 }, fieldHelper: { color: '#7b889d', fontSize: 12, lineHeight: 17, marginTop: -3, marginBottom: 7 }, input: { minHeight: 55, borderRadius: 17, borderWidth: 1, borderColor: '#ccd7e5', backgroundColor: '#fff', paddingHorizontal: 16, color: '#16345f', fontSize: 17 }, inputMultiline: { minHeight: 105, paddingTop: 14 }, segmentRow: { flexDirection: 'row', gap: 10, marginBottom: 15 }, segment: { flex: 1, minHeight: 52, borderRadius: 17, borderWidth: 1, borderColor: '#ccd7e5', backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' }, segmentOn: { backgroundColor: '#0B66FF', borderColor: '#0B66FF' }, segmentText: { color: '#16345f', fontWeight: '900' }, twoColumns: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' }, halfField: { width: '48.5%' }, reviewCard: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#d5dfec', borderRadius: 20, padding: 15, marginTop: 5 }, reviewTitle: { color: '#16345f', fontSize: 20, fontWeight: '900', marginBottom: 4 }, modalActions: { flexDirection: 'row', gap: 10, marginTop: 12 }, actionFull: { flex: 1 },
});
