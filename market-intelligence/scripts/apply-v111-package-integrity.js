...
if (verified.version !== '1.2.8') throw new Error('package integrity failed: version');
console.log('Investor Control market intelligence v1.2.8 package integrity restored.');
